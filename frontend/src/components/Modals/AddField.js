...
function AddField({ setShowFieldModal, setFieldsMCQuestions, fieldsMCQuestions, selectedFieldQuestion}) {
  ...
  const appendField = () =>{
    if(fieldInput !== ""){
        ...
        const oldFields = fieldsMCQuestions[selectedFieldQuestion].fields
        const updatedQuestion = {...fieldsMCQuestions[selectedFieldQuestion], fields :[...oldFields, {text:fieldInput, id:oldFields.length, choices:[]}]}
        fieldsMCQuestionsCopy[selectedFieldQuestion] = updatedQuestion;
          ...
          <div className="border-0 rounded-xl shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="w-[95%]">
                ...
                <div className="flex">
                  <div className="w-[20%] text-[14px] mr-4 font-[400]">
                    <label htmlFor="branch-name">Field Name:</label>
                  </div>
                  <input
            ...
            <div className="flex items-center justify-end p-3 rounded-b">
              <div className=" flex pb-[10px] ">
                ...
                <div onClick={appendField} className="rounded-full cursor-pointer text-[13px] px-6 py-1 text-[#fff] bg-[#0388CC]">
                  Save
                </div>
              </div>
            </div>

      ...
      <div className="m-auto mt-6 flex">
        ...
        <div className="w-full flex flex-col ml-6 text-[#033362] font-semibold">
          ...
          <div className={`${styles.tabs} rounded-xl` }  >
              ...
              <Tab content='CooksByCategory' selectedTab={selectedTab} labelId="label-1" title="Cooks By Category" value='1' handleCheck={handleCheck}/>
              <Tab content='EditCooksCategory' selectedTab={selectedTab}  title="Edit Cooks Category" value='2' handleCheck={handleCheck}/>
            </div>
          </div>
        </div>
      </div>

...
//            'feature_values.*' => ['required', 'integer'],
            ...
            'feature_values.*.feature_id' => ['sometimes', 'integer', 'exists:features,id'],
            'feature_values.*.value_ids' => ['sometimes', 'array'],
            'feature_values.*.value_ids.*' => ['sometimes', 'integer', 'exists:feature_values,id'],

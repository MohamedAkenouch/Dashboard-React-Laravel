      ...
      <div className="m-auto mt-6 flex">
        ...
        <div className="w-full flex flex-col ml-6 text-[#033362] font-semibold">
          ...
          <div className={`${styles.tabs} rounded-xl` }  >
              ...
              <Tab content="BannersPage" selectedTab={selectedTab}  title="Banners" value='1' handleCheck={handleCheck}/>
              <Tab content="BranchesPage" selectedTab={selectedTab}  title="Branches" value='2' handleCheck={handleCheck}/>
            </div>
          </div>
        </div>
      </div>

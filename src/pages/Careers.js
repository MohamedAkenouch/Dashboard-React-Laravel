        ...
        <div className="w-full flex flex-col ml-6 text-[#033362] font-semibold">
          ...
          <div className="bg-[white] grow mt-4 rounded-xl shadow-[0px_0px_16px_rgb(210,215,211)]">
            <div className={`${styles.tabs} rounded-xl` }  >
              ...
              <Tab content='JobApplications' selectedTab={selectedTab} labelId="label-1" title="Job Applications" value='1' handleCheck={handleCheck}/>
              <Tab content='JobsManagement' selectedTab={selectedTab}  title="Jobs Management" value='2' handleCheck={handleCheck}/>
            </div>
          </div>
        </div>
      </div>

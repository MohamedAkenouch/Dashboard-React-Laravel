      ...
      <div className="m-auto mt-6 flex">
        ...
        <div className="w-full flex flex-col ml-6 text-[#033362] font-semibold">
          ...
          <div className={`${styles.tabs} rounded-xl` }  >
              ...
              <Tab content="AdminUsers" selectedTab={selectedTab} labelId="label-1" title="Admin Users" value='1' handleCheck={handleCheck}/>
              <Tab content="Customers" selectedTab={selectedTab}  title="Customers" value='2' handleCheck={handleCheck} users={users}/>
            </div>
          </div>
        </div>
      </div>

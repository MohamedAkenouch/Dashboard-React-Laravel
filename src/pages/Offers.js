      ...
      <div className="m-auto mt-6 flex">
        ...
        <div className="w-full flex flex-col ml-6 text-[#033362] font-semibold">
          ...
          <div className={`${styles.tabs} rounded-xl` }  >
              ...
              <Tab content='Offers' selectedTab={selectedTab} labelId="label-1" title="Offers" value='1' handleCheck={handleCheck}/>
              <Tab content='Coupons' selectedTab={selectedTab}  title="Coupons" value='2' handleCheck={handleCheck}/>
            </div>
          </div>
        </div>
      </div>
